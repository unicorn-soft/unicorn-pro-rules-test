export function verifyJsonPruneFetchResponse(targetEl, verification, parentBox) {
    // verification 파싱: "jsonEquals:window.jsonPruneFetchTestData1:{"content1":"test"}:속성 제거됨"
